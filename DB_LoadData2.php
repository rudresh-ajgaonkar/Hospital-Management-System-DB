...
"chart" => array
(
 "caption" => "NATIONAL_PROVIDER_ID Vs AVG_LENGTH_OF_STAY",
...
*/
$columnChart = new FusionCharts("column2D", "myFirstChart2" , 600, 300, "chart-3", "json", $jsonEncodedData);
// Render the chart
$columnChart->render();
